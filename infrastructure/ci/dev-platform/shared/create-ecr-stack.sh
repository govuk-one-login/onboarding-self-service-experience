...
aws cloudformation create-stack --stack-name container-image-repository \
  ...
  --region eu-west-2 \
  --capabilities CAPABILITY_IAM CAPABILITY_NAMED_IAM CAPABILITY_AUTO_EXPAND --parameters ParameterKey=AWSOrganizationId,ParameterValue='o-pjzf8d99ys\,o-dpp53lco28' \
