...
aws cloudformation create-stack --stack-name infrastructure-audit-hook \
  --template-url https://template-storage-templatebucket-1upzyw6v9cs42.s3.amazonaws.com/infrastructure-audit-hook/template.yaml \
  --region eu-west-2 \
