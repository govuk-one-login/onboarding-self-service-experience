...
aws cloudformation create-stack --stack-name api-gateway-logs \
  --template-url https://template-storage-templatebucket-1upzyw6v9cs42.s3.amazonaws.com/api-gateway-logs/template.yaml \
