import validateAndConvertForCognito from "../../src/middleware/mobileValidator";
...
describe('Validating numbers works as expected', () => {
        ...
        it('accepts valid numbers', async function () {
                for (const validNumber of VALID_NUMBERS) {
                    ...
                    validateAndConvertForCognito('./any-template.njk')(mockRequest as Request, mockResponse as Response, nextFunction as NextFunction);
        ...
        it('rejects invalid numbers', async function () {
                for (const validNumber of INVALID_NUMBERS) {
                    ...
                    mockRequest.body.mobileNumber = validNumber;
                    await expect(validateAndConvertForCognito('./any-template.njk')(mockRequest as Request, mockResponse as Response, nextFunction as NextFunction)).rejects.toThrow(Error);
                }
            }
        );
    }
