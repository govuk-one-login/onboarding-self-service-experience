...
export const TEST_IDENTITY_VERIFICATION_ENABLED_TX = "yes";
export const TEST_IDENTITY_VERIFICATION_ENABLED_ALT = false;
export const TEST_IDENTITY_VERIFICATION_ENABLED_ALT_TX = "no";
