...
const stateMachine: {[route: string]: UserJourneys} = {
    [RegisterRoutes.enterEmailAddress]: {
        ...
        optionalUserJourney: [RegisterRoutes.accountExists, RegisterRoutes.resumeBeforePassword, RegisterRoutes.resumeAfterPassword]
    },
    ...
    [RegisterRoutes.enterTextCode]: {
        ...
        optionalUserJourney: [RegisterRoutes.resendTextCode]
    },
    ...
    [SignInRoutes.enterEmailAddress]: {
        ...
        optionalUserJourney: [RegisterRoutes.resumeAfterPassword, RegisterRoutes.resumeBeforePassword]
    },
