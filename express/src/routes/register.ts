...
router.route("/enter-email-code").get(allowUserJourneyMiddleware, showCheckEmailForm).post(validateEmailSecurityCode, submitEmailSecurityCode);
...
router.route("/resend-text-code").get(allowUserJourneyMiddleware, checkAuthorisation, showResendPhoneCodeForm).post(resendMobileVerificationCode);
router
...
router.route("/resume-before-password").get(allowUserJourneyMiddleware, showCheckEmailForm).post(validateEmailSecurityCode, submitEmailSecurityCode);
