...
(function (Modules) {
    function ShowPassword2($module) {
        this.$module = $module
        this.input = this.$module.querySelector('.gem-c-input-2')
    }

    ShowPassword2.prototype.init = function () {
    ...
    ShowPassword2.prototype.togglePassword = function (event) {
    ...
    ShowPassword2.prototype.revertToPasswordOnFormSubmit = function (event) {
        this.showHide.innerHTML = this.showPasswordText
        this.showHide.setAttribute('aria-label', this.showPasswordFullText)
        this.statusText.innerHTML = this.hiddenPassword
    ...
    ShowPassword2.prototype.moveDataAttributesToButton = function () {
    ...
    Modules.ShowPassword2 = ShowPassword2
})(window.GOVUK.Modules)

window.GOVUK.Modules.ShowPassword2.prototype.constructor(window.document.querySelector(".gem-c-show-password-2"))
window.GOVUK.Modules.ShowPassword2.prototype.init()
