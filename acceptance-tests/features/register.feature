Feature: Users can sign up to the self-service experience
  ...
  Rule: The user tries to submit an email address when creating an account
    ...
    Scenario: The user submits an empty email address
      ...
      Then the error message "Enter your email address" should be displayed for the email field
    ...
    Scenario: The user enters an email address in an incorrect format
      ...
      Then the error message "Enter an email address in the correct format, like name@example.com" should be displayed for the email field
  ...
  Rule: The user tries to verify email security code when creating an account
    ...
    Scenario: The user submits an empty security code
      ...
      Then the error message "Enter the 6 digit security code" should be displayed for the security code field
    ...
    Scenario: The user enters a security code in an incorrect format
      ...
      Then the error message "Your security code should only include numbers" should be displayed for the security code field
      And they should see the text "We have sent an email to: registering-successfully@gds.gov.uk"
  ...
  Rule: The user tries to sign up with an email that is already registered
    ...
    Scenario: The user tries to sign in and enters an empty password
      ...
      Then the error message "Enter your password" should be displayed for the password field
    ...
    Scenario: The user tries to sign in and enters the wrong password
      ...
      Then the error message "Incorrect password" should be displayed for the password field
  ...
  Rule: The user tries to set a password when creating an account
    ...
    Scenario: The user submits an empty password
      When they submit the password ""
      Then they should be redirected to the "/register/create-password" page
      And the error message "Enter a password" should be displayed for the password field

    Scenario: The user enters a password that is fewer than 8 characters
      When they submit the password "Pa$1GOv"
      Then they should be redirected to the "/register/create-password" page
      And the error message "Your password must be 8 characters or more" should be displayed for the password field
  ...
  Rule: The user tries to verify the SMS security code when creating an account
    ...
    Scenario: The user submits an empty code
      ...
      Then they should be redirected to the "/register/enter-text-code" page
      And the error message "Enter the 6 digit security code" should be displayed for the security code field
      And they should see the text "We sent a code to: 07700 900123"

    Scenario: The user submits a code with more than 6 digits
      When they submit the security code "1234567"
      Then they should be redirected to the "/register/enter-text-code" page
      And the error message "Enter the security code using only 6 digits" should be displayed for the security code field
      And they should see the text "We sent a code to: 07700 900123"
    ...
    Scenario: The user submits a code with letters
      When they submit the security code "12345A"
      Then they should be redirected to the "/register/enter-text-code" page
      And the error message "Your security code should only include numbers" should be displayed for the security code field
      And they should see the text "We sent a code to: 07700 900123"
    ...
    Scenario: The user submits an incorrect code
      ...
      Then they should be redirected to the "/register/enter-text-code" page
      And the error message "The code you entered is not correct or has expired - enter it again or request a new code" should be displayed for the security code field
      And they should see the text "We sent a code to: 07700 900123"
  ...
  Rule: The user tries to add a service when creating an account
    ...
    Scenario: The user submits an empty service name
      ...
      Then they should be redirected to the "/register/create-service" page
      And the error message "Enter your service name" should be displayed for the service name field
